...
const Modal = ({setOpenModal, onCreate, title,loading,required}) => {
      ...
      <div className=" flex flex-col gap-7 px-6 py-7  bg-white p-5 rounded-xl shadow-2xl w-full max-w-[423px]">
        ...
        <form
          ...
          <div className="flex justify-between">
           ...
           { loading?<div
              type="submit"
              className="px-4 py-4 mt-10 rounded-xl text-white text-xl bg-[#5570F1] w-full max-w-[180px] text-center"
              >
              Creating...
            </div>: <button
              type="submit"
