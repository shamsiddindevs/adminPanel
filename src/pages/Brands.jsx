...
const Brands = () => {
  ...
  return (
    <div className="flex-1 flex flex-col   h-full overflow-auto p-5">
      ...
      {openModal && <Modal setOpenModal={setOpenModal} title = {"Brands"} loading={loading} onCreate ={onCreate} />}
      {editModal && <EditModal setEditModal={setEditModal} title = {"Brands"} loading={loading} onEdit ={onEdit} categ= {categ} id={id} />}
    </div>
  );
};
