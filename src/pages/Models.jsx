  ...
  return (
    <div className="flex-1 flex flex-col   h-full overflow-auto p-5">
      ...
      <div className="flex justify-between items-center mb-5">
        <h2 className=" text-lg font-medium text-[#45464E]">Models</h2>
        <button
      ...
      {openModal && <Modal setOpenModal={setOpenModal} title = {"Models"} loading={loading} onCreate ={onCreate} />}
      {editModal && <EditModal setEditModal={setEditModal} title = {"Models"} loading={loading} onEdit ={onEdit} categ= {categ} id={id} />}
    </div>
  );
};
